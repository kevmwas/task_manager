const KanbanList = ({ task }) => {
    const taskPriority = task.priority === "LOW" ? "bg-green-400/10 text-green-400" : task.priority === "MEDIUM" ? "bg-blue-400/10 text-blue-400" : task.priority === "HIGH" ? "bg-yellow-400/10 text-yellow-400" : "bg-red-400/10 text-red-400";
    ...
    return (
        <div draggable="true" className="task rounded-xl border border-gray-200 bg-white p-5 shadow-theme-sm dark:border-gray-800 dark:bg-white/5">
            <div className="flex items-start justify-between gap-6">
                ...
                <div className="h-6 w-full max-w-6 overflow-hidden border-gray-200 dark:border-gray-800">
